...
use rslint_core::{
  get_group_rules_by_name, get_rule_by_name, get_rule_suggestion, CstRule,
  CstRuleStore, RuleLevel,
};
use serde::de::{
  value::MapAccessDeserializer, DeserializeSeed, Error, IntoDeserializer,
  MapAccess, Visitor,
};
...
fn from_rule_objects<'de, D>(
  deserializer: D,
) -> Result<Vec<Box<dyn CstRule>>, D::Error>
where
  D: Deserializer<'de>,
{
